...
export async function add(a: number, b: number): Promise<number> {
  return postBinary('/api/v1/add', { operand_a: a, operand_b: b })
}

export async function subtract(a: number, b: number): Promise<number> {
  return postBinary('/api/v1/subtract', { operand_a: a, operand_b: b })
}

export async function multiply(a: number, b: number): Promise<number> {
  return postBinary('/api/v1/multiply', { operand_a: a, operand_b: b })
}

export async function divide(a: number, b: number): Promise<number> {
  return postBinary('/api/v1/divide', { operand_a: a, operand_b: b })
}

export async function power(a: number, b: number): Promise<number> {
  return postBinary('/api/v1/power', { operand_a: a, operand_b: b })
}

export async function sqrt(a: number): Promise<number> {
  return postUnary('/api/v1/sqrt', { operand: a })
}

export async function percentage(a: number): Promise<number> {
  return postUnary('/api/v1/percentage', { operand: a })
}
